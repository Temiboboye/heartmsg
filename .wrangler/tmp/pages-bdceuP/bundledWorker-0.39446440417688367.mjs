...
async function C(e, { request: t, assetsFetcher: a, ctx: s }, { path: r, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        n = k(await a.fetch(A(c, e.path ?? r))), e.headers && _(n.headers, e.headers);
        break;
      }
      case "static": {
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let i = K(e, ye), n = await s.get(r, { softTags: i });
      ...
      case "POST": {
        let i = globalThis[ge], n = /* @__PURE__ */ __name(async () => {
          let o = await e.json();
          o.data.tags === void 0 && (o.tags ??= K(e, me) ?? []), await s.set(r, o);
        }, "n");
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.39446440417688367.mjs.map
