...
`)}}}),d={};((e,t)=>{for(var n in t)u(e,n,{get:t[n],enumerable:!0})})(d,{getOptionalRequestContext:()=>f,getRequestContext:()=>E}),_.exports=c(u({},"__esModule",{value:!0}),d),v(1223);var p=((e,t,n)=>(n=e!=null?x(O(e)):{},c(!t&&e&&e.__esModule?n:u(n,"default",{value:e,enumerable:!0}),e)))(w()),q=Symbol.for("__cloudflare-request-context__");function f(){let e=b[q];if((process?.release?.name==="node"?"nodejs":"edge")=="nodejs")throw Error(p.default`
