...
var Q = V((H) => {
  ...
  function Pe(e, t) {
    ...
    for (var a = {}, s = t || {}, r = s.decode || ke, i = 0; i < e.length; ) {
      var n = e.indexOf("=", i);
      if (n === -1) break;
      var o = e.indexOf(";", i);
      if (o === -1) o = e.length;
...
async function C(e, { request: t, assetsFetcher: a, ctx: s }, { path: r, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        n = k(await a.fetch(L(c, e.path ?? r))), e.headers && _(n.headers, e.headers);
        break;
      }
      case "static": {
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let i = W(e, ye), n = await s.get(r, { softTags: i });
...
var E = class {
  ...
  applyLocaleRedirects(t) {
    ...
    let { locale: { redirect: s, cookie: r } } = t, i = r && this.cookies[r], n = A(i ?? ""), o = A(this.reqCtx.request.headers.get("accept-language") ?? ""), h = [...n, ...o].map((g) => s[g]).filter(Boolean)[0];
    if (h) {
  ...
  getLocaleFriendlyRoute(t, a) {
    return !this.locales || a !== "miss" ? t : z(t.src, this.locales) ? { ...t, src: t.src.replace(/\/\(\.\*\)\$$/, "(?:/(.*))?$") } : t;
  }
...
async function Te(e, { path: t = "/404", status: a, headers: s, searchParams: r, body: i }, n) {
  ...
  } else c = await C(n[t], e, { path: t, status: a, headers: s, searchParams: r });
  let d = s.normal;
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.22983809512291975.mjs.map
