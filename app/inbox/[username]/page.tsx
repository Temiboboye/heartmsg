...
export default function InboxPage() {
    ...
    useEffect(() => {
        ...
        // Fetch wallet balance (force fresh)
        fetch(`/api/wallet/${username}?t=${Date.now()}`, { cache: 'no-store' })
            .then(r => r.json())
    ...
    return (
        <div className="relative min-h-[100dvh] w-full flex flex-col items-center justify-start font-heading text-brand-dark bg-brand-bg selection:bg-brand-rose/20 selection:text-brand-rose">
            ...
            {/* Main Container */}
            <div className="relative flex min-h-screen w-full max-w-md flex-col px-4 pb-48 z-10">
                ...
                <div className="flex-1 w-full space-y-4">
                    {messages.length === 0 ? (
                        <div className="flex flex-col items-center justify-center opacity-50 text-center py-20">
            ...
            <div className="fixed bottom-0 left-0 right-0 z-40 pointer-events-none flex flex-col items-center">
                <div className="w-full max-w-md relative flex flex-col items-center px-6">
                    {/* Gradient Fade to obscure scrolling text underneath */}
                    <div className="absolute bottom-full left-0 right-0 h-24 bg-gradient-to-t from-brand-bg to-transparent"></div>
                    ...
                    <div className="w-full bg-brand-bg pb-6 pt-2 pointer-events-auto flex flex-col items-center gap-5">
                        ...
                        {/* Bottom Navigation */}
                        <div className="glass-panel w-full rounded-full px-2 py-2 flex items-center justify-between shadow-lg shadow-brand-dark/5">
